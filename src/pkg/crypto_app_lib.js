/* @ts-self-types="./crypto_app_lib.d.ts" */
 ...
 * @param {string} text
 * @param {string} key
 * @param {Algorithms} algorithm
 * @returns {string}
 */
export function decrypt_func(text, key, algorithm) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.decrypt_func(ptr0, len0, ptr1, len1, algorithm);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function encrypt_func(text, key, algorithm) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.encrypt_func(ptr0, len0, ptr1, len1, algorithm);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('crypto_app_lib_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
